...
public class DefaultWebSecurityConfig {
	...
	/** Configuración de la autenticación con autenticación en memoria **/
	@Bean
	UserDetailsService userDetailsService(BCryptPasswordEncoder encoder) {
		...
		UserDetails user = User.withUsername("user")
				.password("$2a$12$Pa3IIDS5JhAJpiLt5/lT4O5KVw1pyU.dVGpz/q7kEGUAH.JL85tRC").roles("kie-server").build();
