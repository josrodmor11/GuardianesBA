...
/**
 * Implementación del servicio ClearPasswordService para la identificación en memoria
 * En producción habrá que crear otra implementación que acceda a la base de datos de usuario o a un servicio externo
 */
